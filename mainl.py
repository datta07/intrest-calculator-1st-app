#prepackages-date=15-01-2019,16-01-2019,26-01-2019,28-01-2019
#author-akula guru datta
#app to think more for canvas
...
#building and organiseeing app functions
class builder(App):
	...
	def on_start(self):
		#self.cal()
		final=time.time()
		k=threading.Thread(target=self.cal,args=())
		k.start()
		self.welcome.amounto.text=str(final-start)

	def cal(self):	
		self.welcome.dateo.text=self.welcome.dis('vijayawada',3)
